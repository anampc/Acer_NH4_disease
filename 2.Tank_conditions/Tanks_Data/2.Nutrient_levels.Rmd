...
Nutrients<-read.csv("Data/Nutrient samples_round5.csv")
  ...
  Nutrients$WeekDec<-Nutrients$Day/7
  Nutrients$Week<-as.integer(Nutrients$WeekDec)
  summary(Nutrients)
...
TankNutrients<- ggplot(subset(Nutrients.tall, Treatment=="Ambient"),
  ...
  scale_x_datetime(date_minor_breaks = "1 day", 
               name=("Date"))+
  geom_vline(xintercept = as.numeric(as_datetime("2020-10-18 23:00:00")), linetype=3)+
  geom_vline(xintercept = as.numeric(as_datetime("2020-10-31 23:00:00")), linetype=3)
  

TankNutrients<- ggplot(Nutrients.tall, aes (Day, Concentration, group=(Tank),
...
TankNutrients<- ggplot(filter(Nutrients.tall, Treatment!="Source"), aes (Week, Concentration, 
                                            colour=factor(Treatment))) +
...
```{r}
TankNutrients<- ggplot(filter(Nutrients.tall, Treatment!="Source"),
                       aes (Week, Concentration, fill=factor(Treatment))) +
  ...
  scale_y_continuous(#limits = c(0, 20),
                      ...
                      #  expand = c(0, 0),
                      name=("(uM)"))+
#   geom_vline(xintercept = as.numeric(as.Date("2020-10-18")), linetype=3)+
#   geom_vline(xintercept = as.numeric(as.Date("2020-10-31")), linetype=3)
  geom_vline(xintercept=6.7, linetype="dashed", color="red")+
...
TankNutrients<- ggplot(Nutrients,
                       aes (Date, NH4, shape=(sample), colour=factor(Tank))) +
  #geom_vline(xintercept=1500)+
  #geom_line(linetype=1)+
  geom_line()+
  ...
  scale_y_continuous(#limits = c(0, 20),
                      breaks = seq(0, 35, 2),  
                      #  expand = c(0, 0),
                      name=expression("NH"*~mu*C*")M"))+
  geom_vline(xintercept = as.numeric(as.Date("2020-10-18")), linetype=3)+
  geom_vline(xintercept = as.numeric(as.Date("2020-10-31")), linetype=3)
TankNutrients+facet_wrap(~Treatment)


NO3<- ggplot(Nutrients,
                       aes (Date, NO3.uM., shape=(sample), colour=factor(Tank))) +
  #geom_vline(xintercept=1500)+
  #geom_line(linetype=1)+
  geom_line()+
  geom_point(alpha=1, size=1)+
