...
Fill.colour<-c ("light blue", "dark blue","red","dark red")
...
# Disease phase by Genotype
#***Figure 12***
#(Put in lines manually in Powerpoint)
...
# Genotype plot made by Ana. Not used in report. Made similar plot with panels for each genotype instead so there are less survivorship curves per plot to follow.
...
# Survival plot with panes by genotype
#***Figure 14***
...
# Kaplan-Meier plot using Ana's survivorship data to include nutrients and disease experiment phases
#***Figure 13***
